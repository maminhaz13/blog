      ...
      <div class="login-wrapper wd-300 wd-xs-350 pd-25 pd-xs-40 bg-white">
        ...
        @csrf
            ...
            <div class="form-group">
                ...
                <input id="email" type="email" class="form-control" placeholder="Enter your E-Mail Address" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="mg-t-20 mg-lg-t-0">
                    <label class="ckbox">
                        <input type="checkbox" type="checkbox" name="remember" id="remember" {{ old('remember') ? 'checked' : '' }} checked><span>Remember Me</span>
                    </label>
                </div>
        ...
        <div class="justify-content-center mt-3"><a href="{{ url('login/github') }}" class="btn-block btn btn-dark"><i class="fa fa-github" aria-hidden="true">  Log in with Github</i></a></div>
        <div class="justify-content-center mt-3"><a href="#" class="btn-block btn btn-danger"><i class="fa fa-google" aria-hidden="true">  Log in with Google</i></a></div>
