            ...
            <div class="row">
                <div class="col-lg-9 col-12">
                    <div class="blog-details-wrap">
                        <img src="{{ asset('front') }}/images/blog/blog-details.jpg" alt="">
                        <h3>{{ $blog_post->blog_title }}</h3>
                        <ul class="meta">
                            <li>{{ $blog_post->created_at->diffForHumans() }}</li>
                            <li>By {{ $blog_post->relationship_with_user->name }}</li>
                        </ul>
                        ...
                        <div class="row mb-30">
                            <div class="col-md-5 col-12">
                                <img src="{{ asset('uploads') }}/blog_thumbnail_picture/{{ $blog_post->blog_thumbnail_picture }}" alt="image not found.">
                            </div>
                                    ...
                                    <div class="comment-wrap">
                                        <div class="comment-theme">
                                            <div class="comment-image">
                                                <img src="{{ asset('front') }}/images/comment/1.png" alt="Jhon">
                                            </div>
                                        </div>
                                    ...
                                    {{-- <ul class="children">
                                        <li class="comment odd alt">
                                            <div class="comment-wrap comment-wrap1">
                                                <div class="comment-theme">
                                                    <div class="comment-image">
                                                        <img src="{{ asset('front') }}/images/comment/2.png" alt="Jhon">
                                                    </div>
                                                </div>
                                                <div class="comment-main-area">
                                                    <div class="comment-wrapper">
                                        ...
                                        <div class="sewl-form-inputs no-padding-left">
                                            <div class="row">
                                                <div class="col-sm-6 col-12">
                                                    <input id="name" name="commentor_name" value="" tabindex="2" placeholder="Name" type="text">
                                                </div>
                                                <div class="col-sm-6 col-12">
                                                    <input id="email" name="commentor_email" value="" tabindex="3" placeholder="Email" type="email">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <aside class="sidebar-area">
                        ...
                        <div class="widget widget_recent_entries recent_post">
                            ...
                            <ul>
                                <li>
                                    <div class="post-img">
                                        <img src="{{ asset('front') }}/images/post/1.jpg" alt="">
                                    </div>
                                ...
                                <li>
                                    <div class="post-img">
                                        <img src="{{ asset('front') }}/images/post/2.jpg" alt="">
                                    </div>
                                    <div class="post-content">
                                        <a href="blog-details.html">Lorem Ipsum is simply dummy text of the </a>
                                        <p>19 JAN 2019</p>
                                ...
                                <li>
                                    <div class="post-img">
                                        <img src="{{ asset('front') }}/images/post/3.jpg" alt="">
                                    </div>
                                    <div class="post-content">
                                        <a href="blog-details.html">Lorem Ipsum is simply dummy text of the </a>
                                        <p>19 JAN 2019</p>
                                ...
                                <li>
                                    <div class="post-img">
                                        <img src="{{ asset('front') }}/images/post/4.jpg" alt="">
                                    </div>
                                    <div class="post-content">
                                        <a href="blog-details.html">Lorem Ipsum is simply dummy text of the </a>
                                        <p>19 JAN 2019</p>
